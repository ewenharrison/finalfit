...
I also used [rms](https://cran.r-project.org/web/packages/rms/index.html), including [here](http://journals.plos.org/plosone/article?id=10.1371/journal.pone.0148782) (checkout the nice plots!). I like it and respect the package. But I don’t use it as standard and so need to convert all the models first, e.g. to lrm. Again, for my needs it tries to do too much and I find datadist awkward.
...
<a href="http://www.datasurg.net/wp-content/uploads/2018/07/table1_boot-1024x225.png"><img src="http://www.datasurg.net/wp-content/uploads/2018/07/table1_boot-1024x225.png" alt="" width="600"  class="aligncenter" /></a>
...
<a href="http://www.datasurg.net/wp-content/uploads/2018/07/simulation_plot-1024x567.png"><img src="http://www.datasurg.net/wp-content/uploads/2018/07/simulation_plot-1024x567.png" alt="" width="600"  class="aligncenter" /></a>
