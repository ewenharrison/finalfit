...
Thirdly, I love [Stan](https://mc-stan.org/users/interfaces/rstan) for this, e.g. used in this [paper](https://www.thelancet.com/journals/laninf/article/PIIS1473-3099(18)30101-4/fulltext). The generated quantities block allows great flexibility to simulate whatever you wish from the posterior. I’m a Bayesian at heart will always come back to this. But for some applications it’s a bit much, and takes some time to get running as I want.
