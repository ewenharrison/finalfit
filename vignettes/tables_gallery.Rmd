...
### 1.02 P-value for hypothesis test
...
### 1.03 Median (interquartile range) instead of mean (standard deviation)
...
### 1.04 Missing values for the explanatory variables
...
### 1.05 Column proportions (rather than row)
...
### 1.07 Order a variable by total
...
### 1.08 Label with `dependent` name
...
### 1.09 Dependent variable with 0 to 5 factor levels supported
...
### 1.10 Explanatory variable defaults to factor when ≤5 distinct values
...
### 1.11 Keep as continous variable when ≤5 distinct values
