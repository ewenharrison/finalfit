...
### 1.2 P-value for hypothesis test
...
### 1.3 Median (interquartile range) instead of mean (standard deviation)
...
### 1.4 Missing values for the explanatory variables
...
### 1.5 Column proportions (rather than row)
...
### 1.9 Dependent variable with 0 to 5 factor levels supported
...
### 2.09 Confidence interval level
...
### 2.10 Confidence interval separation
...
### 2.11 Mixed effects random-intercept model
...
<<<<<<< HEAD
### 2.12 Mixed effects random-slope model
=======
### 2.11 Mixed effects random-slope model
>>>>>>> 1727ad56b1fe031e44db269a7f69e76be39e67cc
...
<<<<<<< HEAD
### 2.13 Mixed effects random-slope model directly from `lme4`
=======
### 2.12 Mixed effects random-slope model directly from `lme4`
>>>>>>> 1727ad56b1fe031e44db269a7f69e76be39e67cc
...
<<<<<<< HEAD
### 2.14 Exclude all missing data in final model from univariable analyses 
=======
## 2.13 Exclude all missing data in final model from univariable analyses 
>>>>>>> 1727ad56b1fe031e44db269a7f69e76be39e67cc
...
<<<<<<< HEAD
### 2.16 Mixed effects random-intercept linear regression
=======
## 2.15 Mixed effects random-intercept linear regression
>>>>>>> 1727ad56b1fe031e44db269a7f69e76be39e67cc
...
<<<<<<< HEAD
### 2.17 Mixed effects random-slope linear regression
=======
## 2.15 Mixed effects random-slope linear regression
>>>>>>> 1727ad56b1fe031e44db269a7f69e76be39e67cc
...
<<<<<<< HEAD
### 2.18 Cox proportional hazards model (survival / time to event)
...
### 2.19 Cox proportional hazards model: change dependent label
...
<!--  para %>% -->
<!--   finalfit.glm(dependent, explanatory, digits = c(4,4,4)) -->
...
<!-- library(survey) -->
<!-- # Specify variables -->
<!-- explanatory = c("age.factor*sex.factor", "nodes", "obstruct.factor", "perfor.factor") -->
<!-- dependent = 'mort_5yr' -->

<!-- # Run model for term test -->
<!-- model1 <- glm(ff_formula(dependent, explanatory), data=colon_s, family = binomial) -->
<!-- term_test <- regTermTest(model1, "age.factor:sex.factor") -->

<!-- # Run final table with results of term test -->
<!-- colon_s %>% -->
<!--     finalfit(dependent, explanatory) %>% -->
<!--     rbind(c( -->
<!--         "age.factor:sex.factor", -->
<!--         "Interaction", -->
<!--         "-", -->
<!--         "-", -->
<!--         "-", -->
<!--         paste0("p", term_test$p %>% p_tidy(3)) -->
<!--     )) -->