...
### 1.07 Row proportions (rather than column)
...
### 1.10 Order a variable by total
...
### 1.11 Label with `dependent` name
...
### 1.12 Dependent variable with any number of factor levels supported
...
### 1.13 Explanatory variable defaults to factor when ≤5 distinct values
...
### 1.14 Keep as continous variable when ≤5 distinct values
